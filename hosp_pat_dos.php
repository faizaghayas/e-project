                  ...
                  if(mysqli_num_rows($result2) > 0) {
                    while ($row =mysqli_fetch_assoc($result2)) {
                      ...
                      <tbody>
                        ...
                        <?php
                        if($row['dos_1'] == 0){
                            $dos_bttn="badge-outline-warning";
                            $dos_msg= "Pending";
                        }    
                        ?>
                          <?php
                        if($row['dos_1'] == 1){
                            $dos_bttn="badge-outline-success";
                            $dos_msg= "Done";
                        }    
                        ?>
                        <a href="1_dos.php?fd_id=<?php echo $row['parent_id'] ?>&h_id=<?php echo $hos_id; ?>&u_id=<?php echo $u_id; ?>">
                              <div class="badge <?php echo $dos_bttn?>"><?php echo $dos_msg?></div>
                            </a></td>
                          <td>
                          <?php
                        if($row['dos_2'] == 0){
                        ...
                        ?>  
                          <a href="2_dos.php?sd_id=<?php echo $row['parent_id'] ?>&h_id=<?php echo $hos_id; ?>&u_id=<?php echo $u_id; ?>">
                              <div class="badge <?php echo $dos_bttn?>"><?php echo $dos_msg?></div>
                            </a></td>
                        </tr>
                        <?php
